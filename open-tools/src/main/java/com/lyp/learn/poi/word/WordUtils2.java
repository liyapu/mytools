...
/**
 * Apache POI Word中的表格  https://www.jianshu.com/p/603108a48088
 *
 * 百度下载的工具类，原始
 */
public class WordUtils2 {
    public static void main(String[] args) throws Exception {
        WordUtils2 t = new WordUtils2();
        ...
        String filePath = WordUtils2.class.getClassLoader().getResource("").getPath();
        String filePathName = filePath + "testword.docx";
    ...
    public void setParagraphShdStyle(XWPFParagraph p, boolean isShd,
        ...
        if (shdColor != null) {
            //设置背景颜色，setColor若是不好用，就用setFill 试试
