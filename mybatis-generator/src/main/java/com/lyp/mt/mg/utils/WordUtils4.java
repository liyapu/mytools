...
/**
 * 添加 单元格 位置的控制 vertical position
 *
 */
public class WordUtils4 {
    public static void main(String[] args) throws Exception {
        WordUtils4 t = new WordUtils4();
        XWPFDocument doc = new XWPFDocument();

        // 测试表格样式
        t.testTableStyle(doc);

        String filePath = WordUtils4.class.getClassLoader().getResource("").getPath();
        String filePathName = filePath + "testword1.docx";
    ...
    public void testTableStyle(XWPFDocument doc) {
        ...
        for (String str : columnList) {
            if (str.indexOf("|") == -1) {
                ...
                setCellText(firstCell, str, 1600, false, 0, rowBgColor,null,null);
                firstCellIndex++;
            } else {
