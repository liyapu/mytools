...
public class ExecutorTest {
    ...
    private static ExecutorService executor2 = new ThreadPoolExecutor(15,
            70,
            0L,
            TimeUnit.SECONDS,
    ...
    private static ExecutorService executor3 = new ThreadPoolExecutor(15,
            70,
            0L,
            TimeUnit.SECONDS,
            new LinkedBlockingQueue<Runnable>(1),
    ...
    private static ExecutorService executor4 = new ThreadPoolExecutor(100,
            120,
            20L,
            TimeUnit.SECONDS,
    ...
    public static void main(String[] args) throws Exception {
        ExecutorService executor4 = new ThreadPoolExecutor(100,
                120,
                20L,
                TimeUnit.SECONDS,
                new LinkedBlockingQueue<Runnable>(20),
